...
export const metadata: Metadata = {
  title: "How to Convert Word to PDF | CalmPDF",
...
export default function Page() {
  return (
    <ArticleShell post={post}>
      <h1 className="text-3xl font-semibold tracking-tight mb-4">How to Convert Word to PDF</h1>
      ...
      <p className="text-sage-700 mb-6"><a href="/word-to-pdf" className="text-sage-900 underline underline-offset-4">Try CalmPDF Word to PDF converter.</a></p>
    </ArticleShell>
  );
}
