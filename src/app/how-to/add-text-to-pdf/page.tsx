...
export const metadata: Metadata = {
  title: 'How to Add Text to a PDF | Free Online Tool',
  ...
  keywords: ['add text to PDF', 'edit PDF text', 'add text to PDF free', 'PDF text editor', 'annotate PDF'],
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'HowToArticle',
  headline: 'How to Add Text to a PDF',
  description: 'Complete guide to adding text to PDFs using free online tools',
  image: 'https://calmpdf.vercel.app/og-image.png',
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      <article className="max-w-3xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-slate-900">
          <h1 className="text-4xl font-bold tracking-tight mb-6">How to Add Text to a PDF</h1>
          ...
          <h2 className="text-2xl font-semibold mt-10 mb-4">Methods to Add Text to a PDF</h2>

          <h3 className="text-xl font-semibold mt-8 mb-4">1. Use a Browser-Based PDF Editor</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4">2. Use Google Docs (Free Alternative)</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4">3. Adobe Acrobat (Paid)</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4">4. CalmPDF (Coming Soon)</h3>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-10 mb-4">Why Use a Privacy-First Tool</h2>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Can I add text to a PDF for free?</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Do online PDF editors upload my files?</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">What's the difference between adding text and filling a form?</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Can I change font size and color when adding text?</h3>
          <p>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mt-10 rounded">
            <p className="text-base text-blue-900">
              <strong>Try CalmPDF for compression and merging:</strong> While we work on text editing, explore CalmPDF's fast, private PDF tools for compressing documents, merging PDFs, and splitting large files.
            </p>
            <a
              href="/compress-pdf"
