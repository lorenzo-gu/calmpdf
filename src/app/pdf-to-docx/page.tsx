  ...
  return (
    <ToolShell tool={tool}>
      ...
      <section className="mt-10 space-y-6 text-sage-700">
        ...
        <p>
          Once you have your editable DOCX, you can keep working with the source PDF using CalmPDF&apos;s other browser-based tools. Add a signature, redact a section, or insert text with{" "}
